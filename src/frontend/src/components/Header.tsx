...
const ROUTE_TITLES: Record<string, string> = {
  ...
  "/admin/bookings/invoices": "Invoices",
  "/admin/users/add": "Add User",
  "/admin/users/all": "All Users",
  "/admin/technicians/add": "Add Technician",
  "/admin/technicians/list": "Technician List",
  "/admin/services/add": "Add Service",
  "/admin/services/list": "Service List",
  "/admin/technician/jobs": "My Jobs",
  "/admin/customer/bookings": "My Bookings",
